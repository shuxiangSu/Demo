      ...
      _createClass(BootstrapTable, [{
        ...
        value: function initHeader() {
          ...
          this.options.columns.forEach(function (columns, i) {
            ...
            columns.forEach(function (column, j) {
              ...
              if (column.checkbox) {
                text = '';
                if (!_this2.options.singleSelect && _this2.options.checkboxHeader && column.checkboxHeader) {
        ...
        value: function fitFooter() {
          ...
          this.$tableFooter.css({
            'margin-right': scrollWidth
            }).find('table').attr('class', this.$el.attr('class'));
          ...
          this.$body.find('>tr:first-child:not(.no-records-found) > *').each(function (i, el) {
            ...
            //$footerTd.eq(i).width($this.width()).attr('class','success');
        $footerTd.eq(i).width($this.innerWidth()).attr('class','success');
